...
Реестр: `src/lib/taskTeaching.ts`. Срез runtime `allBlocks`: 1324 заданий, 16 используемых `kind`, 159 семейств объяснений. Union `choice` также поддержан, но в текущем курсе таких заданий нет.
...
| `picture.find-digit`                                        | `p001-block02`  |    13 |
